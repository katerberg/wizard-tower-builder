...
_Exists on `main`; add Kindled hook._
...
| Patch lifetime     | **~15s** _(upgrade later: whole wave)_                                                                |
...
| Patch damage       | **None**                                                                                              |
| Visibility         | **Clear VFX** on the trap tile — readable for you and fair for learning routes _(not “hidden mine”)_) |
