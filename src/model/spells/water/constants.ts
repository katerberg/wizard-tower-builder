...
/** Puddle lifetime from Waterfall terminus (seconds). */
export const WATERFALL_PUDDLE_LIFETIME = 6;
...
/** Sheet wet lifetime on walls (seconds) — dissipates quickly. */
export const SHEET_LIFETIME = 1.2;
