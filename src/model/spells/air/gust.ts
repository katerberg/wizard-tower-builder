...
import { applyCollisionDamage, detachEnemy, wasOnWall } from './fallCollision';
import { GUST_PUSH_SUB_CELLS } from './constants';
import {
  gustAffectedCells,
  computePushDelta,
...
export const gust: SpellDef = {
  ...
  range: 8,
  damage: 0,
  previewCells: (_state, cell) => gustAffectedCells(cell),
  cast(ctx, target) {
