...
export const manaSpringRoom: RoomBehaviorDef = {
  blueprintId: 'manaSpringRoom',
  mechanics: 'Staffed magi regenerate mana while the spring is water-connected.',
  roles: ['manaSpring'],
  tick: tickManaSprings,
};
