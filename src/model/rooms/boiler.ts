...
export const boilerRoom: RoomBehaviorDef = {
  blueprintId: 'boilerRoom',
  mechanics: 'Consumes mana to produce steam while connected to water and steam pipes.',
  roles: ['boiler'],
  tick: tickBoilers,
  reset: resetBoilerRuntime,
};
